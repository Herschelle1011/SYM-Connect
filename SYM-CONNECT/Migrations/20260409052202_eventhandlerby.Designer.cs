...
namespace SYM_CONNECT.Migrations
{
    ...
    [Migration("20260409052202_eventhandlerby")]
    partial class eventhandlerby
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SYM_CONNECT.Models.Event", b =>
                {
                    ...
                    b.Property<int?>("EventHandlerById")
                        .HasColumnType("int");

                    b.Property<int?>("EventHandlerByUser")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SYM_CONNECT.Models.Event", b =>
                {
                    ...
                    b.HasOne("SYM_CONNECT.Models.Users", "EventHandlerBy")
                        .WithMany()
                        .HasForeignKey("EventHandlerById");
