...
namespace SYM_CONNECT.Migrations
{
    ...
    [Migration("20260406052230_updateEventModelAddGroupList")]
    partial class updateEventModelAddGroupList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SYM_CONNECT.Models.Event", b =>
                {
                    ...
                    b.Property<int?>("AssignedGroupGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssignedGroupGroupId");
            ...
            modelBuilder.Entity("SYM_CONNECT.Models.Event", b =>
                {
                    ...
                    b.HasOne("SYM_CONNECT.Models.SYMGroup", "AssignedGroup")
                        .WithMany()
                        .HasForeignKey("AssignedGroupGroupId");
